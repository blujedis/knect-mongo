...
export declare class KnectMongo {
    ...
    model<T, S = any>(ns: string, schema?: ISchema<T, S>): {
        ...
        find(query?: import("mongodb").FilterQuery<T>, options?: import("./types").IFindOneOptions): Promise<T[]>;
        findOne(id: import("./types").LikeObjectId, options: import("./types").IFindOneOptions, cb?: import("mongodb").MongoCallback<T>): Promise<T>;
        findOne(id: import("./types").LikeObjectId, cb?: import("mongodb").MongoCallback<T>): Promise<T>;
        findOne(query: import("mongodb").FilterQuery<T>, options: import("./types").IFindOneOptions, cb?: import("mongodb").MongoCallback<T>): Promise<T>;
        findOne(query: import("mongodb").FilterQuery<T>, cb?: import("mongodb").MongoCallback<T>): Promise<T>;
        findModel(id: import("./types").LikeObjectId, options?: import("./types").IFindOneOptions, cb?: import("mongodb").MongoCallback<BaseModel<T> & T>): Promise<BaseModel<T> & T>;
        ...
        updateOne(id: import("./types").LikeObjectId, update: Partial<T> | import("mongodb").UpdateQuery<Partial<T>>, options: import("mongodb").UpdateOneOptions, cb?: import("mongodb").MongoCallback<import("mongodb").UpdateWriteOpResult>): Promise<import("mongodb").UpdateWriteOpResult>;
        updateOne(id: import("./types").LikeObjectId, update: Partial<T> | import("mongodb").UpdateQuery<Partial<T>>, cb?: import("mongodb").MongoCallback<import("mongodb").UpdateWriteOpResult>): Promise<import("mongodb").UpdateWriteOpResult>;
        ...
        excludeOne(id: import("./types").LikeObjectId, update: Partial<T> | import("mongodb").UpdateQuery<Partial<T>>, options: import("mongodb").UpdateOneOptions, cb?: import("mongodb").MongoCallback<import("mongodb").UpdateWriteOpResult>): Promise<import("mongodb").UpdateWriteOpResult>;
        excludeOne(id: import("./types").LikeObjectId, update: Partial<T> | import("mongodb").UpdateQuery<Partial<T>>, cb?: import("mongodb").MongoCallback<import("mongodb").UpdateWriteOpResult>): Promise<import("mongodb").UpdateWriteOpResult>;
